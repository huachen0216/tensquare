...
CREATE TABLE `tb_city`  (
  ...
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市名称',
...
CREATE TABLE `tb_label`  (
  ...
  `labelname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标签名称',
  ...
  `recommend` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否推荐',
...
-- Records of tb_label
-- ----------------------------
INSERT INTO `tb_label` VALUES ('1071649597811724288', 'JAVA', '1', 1, '2', NULL);
INSERT INTO `tb_label` VALUES ('1071649945116872704', 'C++', '1', NULL, '2', NULL);
INSERT INTO `tb_label` VALUES ('1071649945116872705', 'PYTHON', '1', NULL, '3', NULL);
INSERT INTO `tb_label` VALUES ('1071649945116872706', 'GoLang', '1', NULL, '4', NULL);

...
CREATE TABLE `tb_gathering`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动名称',
  `summary` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '大会简介',
  `detail` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '详细说明',
  `sponsor` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '主办方',
  `image` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动图片',
  `starttime` datetime(0) DEFAULT NULL COMMENT '开始时间',
  `endtime` datetime(0) DEFAULT NULL COMMENT '截止时间',
  `address` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '举办地点',
  `enrolltime` datetime(0) DEFAULT NULL COMMENT '报名截止',
  `state` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否可见',
...
CREATE TABLE `tb_usergath`  (
  ...
  `exetime` datetime(0) DEFAULT NULL COMMENT '点击时间',
